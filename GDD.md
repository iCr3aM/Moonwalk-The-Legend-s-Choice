...
- **其他**：成就 30 项（图鉴可重置）、关键选择回顾、社交分享（传奇海报）、变体池 34+、媒体/孤独属性、单文件构建与成就双发修复。【§16.1 ✅】
- **本地化（部分）**：EN 文案骨架 + 核心 EN（find_missing_en=0，en_smoke 通过）。【§13 P1 ✅】

### 规划 / 待办（尚未实现）
- **多语言 i18n 全量**：事件 EN 全集、数字/货币格式化、字体字距回退。【§13 P2/P3】
- **深度游玩系统**：关系网深化 / 专项子维度 / 决策风格档案（创作企划器已在 §17.14 部分落地）。【§17.4】
- **重复游玩增强**：挑战/每日模式、纯净/硬核、NG+ 轻量、结局达成向导、最接近结局提示。【§17.5】
- **剧情与文案拓展**：独白尾声扩写、舆论轴深化(M5)、心理轴扩写(M6)、时代切片扩写(M3)。【§17.6】
...
### 17.5 重复游玩增强（重玩性）★规划
> 目标：让"集齐 18 结局 + 30 成就"之外，仍有持续回来玩的理由。
...
*文档结束 — v1.3（续章 2010–2026 + 18 结局 + §17.3/§17.7/§17.8 拓展已落地；「〇、实现状态总览」已实现/待办分离；§17.15 续章·2019+ 舆论与法律延续已落地（8_5b 点名《逃离梦幻岛》+ 8_9 Cascio 2025–2026 诉讼，接入 8_5→8_9→8_7，EN 全量）；§17.11 趣事与轶事系统已落地（MJ.triviaSystem 24 条考据趣事 + V_TIDBIT_* 6 个 flavor 变体 + hypothetical vignettes「假如…（想象）」+ 趣事图鉴弹窗/Toast，EN 全量）；§17 多数扩展已落地，并新增 §17.4–§17.10 扩展路线图；其中 §17.8 A/B/C 与 §17.9 已于 2026-09-04 落地，§17.7 已于 2026-09-04 落地，§17.11 已于 2026-09-04 落地，其余 §17.4–§17.6、§17.10 仍为规划项）*

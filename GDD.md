...
*文档结束 — v0.8（续章 2010–2026 + 14 结局 + 图鉴/成就重置与稀有度排序 + 资产现实校准；§17 多数扩展已落地，并新增 §17.4–§17.10 规划扩展路线图：深度游玩 / 重复游玩 / 剧情拓展 / 更多结局·事件·架空分支 / 彩蛋 / 优化；以上规划项尚未实现）*

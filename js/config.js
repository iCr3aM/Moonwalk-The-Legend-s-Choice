...
(function () {
  ...
  C.endings = {
    ...
    END_ETERNAL: {
      ...
      hint: '把艺术(≥75)、声誉(≥65)、健康(≥55)推到高位，全程不被烧伤，并触发《Thriller 25》加冕或 30 周年纪念（拿到双标志之一）。',
    ...
    END_TRUE_ETERNAL: {
      ...
      hint: '极致路线：艺术/声誉≥85、健康≥72、慈善家≥3、艺术家≥2，并同时拿到 Thriller25 与 30 周年双加冕、全程不烧伤不负债。',
    ...
    END_STATESMAN: {
      ...
      hint: '兼顾慈善（≥2 级）与高声誉(≥70)、和睦家庭(≥55)，且不负债。',
    ...
    END_MENTOR: {
      ...
      hint: '在慈善、家庭(≥50)与艺术(≥60)兼顾的同时，多选择提携/帮助后辈的选项。',
    ...
    END_RECLUSE_SERENE: {
      ...
      hint: '隐士路线为主，但注意健康≥50、保持家庭/媒体不低迷，避免孤独度过高。',

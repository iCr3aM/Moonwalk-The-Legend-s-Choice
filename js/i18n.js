  ...
  var i18n = {
    ...
    dict: {
      ...
      en: {
        ...
        'ending.END_ALT_STAY_MOTOWN.hint': 'At the 1975 fork, choose "Stay at Motown" (alt-decision BP1) — a family route without the solo legend.',
        ...
        'ending.END_ALT_NO_QJ.hint': 'At the 1979 fork, choose "Independent Production" (alt-decision BP2) — skip the hit-making maestro and take the helm yourself.',
        ...
        'ending.END_ALT_HEALED.hint': 'At the 1984 fork, choose "Steady Recovery" (alt-decision BP3; §17.15 neutral only) — take the serene, healed-recluse route.',
        ...
        'ending.END_ALT_MEDIA_MOGUL.hint': 'At the business fork, choose "Build a Media Empire" (alt-decision BP6) — forge the mogul route into its own line.',
        ...
        'ending.END_ALT_PEACE_LAUREATE.hint': 'In the 1993 / 2003 storms, choose "Turn to Charity" (alt-decision BP4/BP5) — push goodwill to its height and earn international honor.',
        ...
        'ending.END_ALT_SURVIVE_LEGACY.hint': 'At the post-2009 fork, choose "Live On" (alt-decision BP7, extending the epilogue line) — give life a sequel.',
        ...
        'ending.END_ALT_QUIET_RETIREE.hint': 'With a solid family, choose "Retire to the Estate" (alt-decision, family-facing) — give your remaining years to kin and the garden.',

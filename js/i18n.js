  ...
  var i18n = {
    ...
    dict: {
      ...
      en: {
        ...
        'ui.locked': 'Locked',
        'ui.yearSuffix': '', // U3#1：EN 年份无「年」字后缀（设计性空值，已入 EN_EMPTY_OK 门禁白名单）
        'ui.unknown': '???',
        ...
        'ui.posterHighlight': 'Highlight Moments',
        'ui.achNarrLead': 'Looking back on this journey, a few moments burn brightest -',
        'ui.achNarrTail': 'They were never rewards, only signposts.',
        'achNarr.ACH_ETERNAL': 'My name became a symbol - a white glove closer to eternity than any gold record.',
        'achNarr.ACH_TRUE_ETERNAL': 'This time, I wrote the word eternal into history myself.',
        'achNarr.ACH_BIOPIC': 'Someone else played my life on the big screen.',
        'achNarr.ACH_BIOPIC_SELF': 'This time I played myself - the screen and the soul were both real.',
        'achNarr.ACH_BEYOND': 'I proved that some presence, time cannot take away.',
        'achNarr.ACH_ALL_ENDINGS': 'I lived every kind of life - and I am still me.',
        'achNarr.ACH_ALT_SURVIVE_LEGACY': 'Every day after 2009 was an encore I never expected to sing.',
        'achNarr.ACH_STAGE_LEGEND': 'The stage remembers me, the way it remembers a legend.',
        'achNarr.ACH_PHIL_LEGEND': 'With song and kindness, I warmed two worlds at once.',
        'achNarr.ACH_MOGUL': 'Every square of the catalog map carried my seal.',
        'achNarr.ACH_ARTIST': 'On the road of art, I walked myself into a master.',
        'achNarr.ACH_TOUR': 'The stadium lights were all thrones of mine.',
        'achNarr.ACH_RICH': 'The numbers proved a dream can be good business, too.',
        'achNarr.ACH_COMEBACK': 'The step out of the fire was harder than any dance move.',
        'achNarr.ACH_TIMELESS_KING': 'Spotlights changed generation after generation; the one still standing was me.',
        'achNarr.ACH_DIGITAL_PIONEER': 'I handed my single to the future first.',
        'achNarr.ACH_END_INNOVATOR': 'I redrew the borders of music with technology.',
        'achNarr.ACH_GRAMMY_SWEEP': 'Every trophy from six albums was engraved with my name.',
        'achNarr.ACH_HIGH_STAKES': 'That gamble won back the whole podium.',
        'achNarr.ACH_GRAMMY_LEGEND': 'In the Grammy record books, one page belongs to me alone.',
        'achNarr.ACH_DREAMER': 'I built my childhood dream into a real wonderland.',
        'achNarr.ACH_THISISIT': 'The show I never finished was my last note to the stage.',
        'achNarr.ACH_CATALOG_KING': "The Beatles' songs once slept under my name.",
        'achNarr.ACH_COMEBACK_2': 'I said I would come back - and I did.',
        'achNarr.ACH_EGG_HUNTER': 'I found every secret this era had hidden.',
        'achNarr.ACH_VARIANT_20': 'I visited every fork in the road of fate.',
        'achNarr.ACH_ALT_MEDIA_MOGUL': 'On that fork of fate, I became the king of media.',
        'achNarr.ACH_ALT_PEACE_LAUREATE': 'The laurel of peace was once placed on my head.',
        'achNarr.ACH_WHOLE_LIFE': 'Family and dreams - I never let go of either.',
        'achNarr.ACH_DIAMOND': 'Diamond certified: my voice was truly priceless.',
        'achNarr.ACH_GRAMMYLEGEND': 'The trophies lined up like a band playing for me.',
        'achNarr.ACH_PEACE_AMBASSADOR': 'I turned my stage into a podium for peace.',
        'achNarr.ACH_CROWN': 'Elizabeth Taylor crowned me herself: the King of Pop.',
        'achNarr.ACH_NEVERLAND': 'I rebuilt a Neverland where I never had to grow up.',
        'achNarr.ACH_SMOOTH': 'That glide slid straight into the memory of a decade.',
        'achNarr.ACH_GREATWALL': 'I sang on the Great Wall - the valley sang back.',
        'achNarr.ACH_DANCE_GOD': "They call me the God of Dance; I don't argue.",
        'achNarr.ACH_VMA': 'In my hands, a music video first became cinema.',
        'achNarr.ACH_END_MENTOR': 'I shared my light with those who came after.',
        'achNarr.ACH_PACIFIST': 'I never let a lawsuit stain my name.',
        ...
        'ui.posterFlipHint': 'Tip: tap “Next Page” for your legend monologue & epilogue; long-press to save',
        ...
        'diary.0.2': "The first time I heard the word 'copyright'. So songs, once sung, are seeds that can be kept and grown again and again.",
        'diary.0.3': "My name began to appear in the papers. When people read 'the little Jackson boy', I made every note crisper.",
        ...
        'diary.1.3': "Outside the studio I stared at contracts deep into the night. The instinct that belongs to melody can also measure the pulse of business.",
        'diary.1.4': "On the phone, my mother's voice. No matter how big the stage, someone at the other end of the rope always keeps a bowl of soup warm for me.",
        ...
        'diary.2.3': "After every party I want to run home. The brighter the spotlight, the more I miss that narrow room full of brothers.",
        'diary.2.4': "My face is on walls across five continents. That weight must be carried with a lifetime of work.",
        ...
        'diary.3.3': "The front pages are making up stories again. I learned to fold the clippings into a drawer — that is someone else's pen, not my life.",
        'diary.3.4': "The numbers on the ledger have grown into a mountain. I remind myself: money is an instrument, not the work.",
        ...
        'diary.4.3': "The estate is huge, and so are its echoes. I count the lamps at the end of the hall, the way I once counted my brothers' breaths.",
        'diary.4.4': "At the negotiating table I am calmer than on stage. The lamps on both tables light up the same person.",
        'diary.4.2': "In the summer of 2009 many things were set to close. I shut the score and heard that Gary boy, clapping first.",
        'diary.5.0': "This time I no longer schedule tours ahead of birthdays. The kids' backpacks and my scores live in the same room.",
        'diary.5.1': "People have begun to call me a legend. But I know what a legend fears most is not growing old — it is stopping.",
        'diary.5.2': "My hands still remember every beat. New melodies wake me before dawn, just like forty years ago.",
        'diary.5.3': "Every extra year is a gift. I write slowly, sing slowly, and push the curtain call a little further away.",
        ...
        'echo.7': "Echo of fate: the hand that led you through Motown's door never really let go — it simply stayed behind you.",
        'echo.8': "Echo of fate: you took the rumor that pinned you to the headlines and rewrote it into a footnote of reversal.",
        'echo.9': "Echo of fate: the moments childhood never caught, you spent a lifetime learning to catch yourself.",
        'echo.10': "Echo of fate: every borrowed year became an encore you sang on time's behalf.",
        'echo.11': "Echo of fate: a coronation is not a finish line — the heavier the crown, the more you remember why you began.",
        ...
        'vignette.craftsman.0': "If you had polished every master tape fifty times over, would the world have received a flawless record?",
        'vignette.craftsman.1': "If you had spent every coin where it counted and toured with steady hands, would the story have been smoother — and less legendary?",
        'vignette.innovator.0': "If you had tested every 'impossible' one by one, would music history have turned its page ten years early?",
        'vignette.default.0': "If time could rewind one second, which stage would you return to?",
        'vignette.default.1': "If that coronation stage had been one size bigger, would you still have feared standing at its very center?",
        'vignette.default.2': "If that rehearsal in 2009 had been just an ordinary run-through, what is the first thing you would have done the next morning?",
